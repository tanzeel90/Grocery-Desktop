...
!function (t) {
    ...
    function (n) {
        ...
        n.fn.emulateTransitionEnd = function (t) {
            var e = !1, i = this; n(this).one("bsTransitionEnd", function () { e = !0 });
    ...
    function (s) {
                    ...
                    setTimeout(s.proxy(function () {
                        i[o](null == n[t] ? this.options[t] : n[t]),
                            "loadingText" == t ? (this.isLoading = !0,
                                i.addClass(e).attr(e, e).prop(e, !0)) : this.isLoading && (this.isLoading = !1, i.removeClass(e).removeAttr(e).prop(e, !1))
                    },
                        this),
                        0)
            },
        ...
        s.fn.button = i,
            ...
            s(document).on("click.bs.button.data-api", '[data-toggle^="button"]',
                function (t) {
    ...
    function (p) {
        ...
        var c = function (t, e) {
            this.$element = p(t),
                ...
                "hover" == this.options.pause && !("ontouchstart" in document.documentElement) && this.$element.on("mouseenter.bs.carousel",
                    p.proxy(this.pause, this)).on("mouseleave.bs.carousel",
        ...
        function r(n) {
            return this.each(function () {
                var t = p(this),
                    ...
                    o = "string" == typeof n ? n : i.slide; e || t.data("bs.carousel", e = new c(this, i)),
        ...
        c.VERSION = "3.4.1",
            ...
            c.prototype.cycle = function (t) {
                return t || (this.paused = !1),
                    ...
                    this.options.interval && !this.paused && (this.interval = setInterval(p.proxy(this.next, this),
            ...
            c.prototype.getItemForDirection = function (t, e) {
                ...
                if (
                    ("prev" == t && 0 === i || "next" == t && i == this.$items.length - 1) && !this.options.wrap)
                    return e;
                    ...
                    return p.support.transition && this.$element.hasClass("slide") ? (o.addClass(t),
                        ...
                        i.one("bsTransitionEnd", function () {
                            o.removeClass([t, s].join(" ")).addClass("active"),
                                ...
                                a.sliding = !1, setTimeout(function () { a.$element.trigger(d) }, 0)
                        })
                            .emulateTransitionEnd(c.TRANSITION_DURATION)) : (i.removeClass("active"),
                                o.addClass("active"),
                                this.sliding = !1,
                                this.$element.trigger(d)), n && this.cycle(), this
                }
            };
        var t = p.fn.carousel;
        p.fn.carousel = r,
        ...
        p(document).on("click.bs.carousel.data-api",
            "[data-slide]",
                ...
                if (!this.transitioning && this.$element.hasClass("in")) {
                    ...
                    if (this.$element.trigger(t),
                        ...
                        this.$element[e](0).one("bsTransitionEnd",
                            a.proxy(i, this)).emulateTransitionEnd(r.TRANSITION_DURATION)
                    }
                }
            },
    ...
    function (a) {
        ...
        var t = a.fn.dropdown; a.fn.dropdown = function e(i) {
            ...
            a(document).on("click.bs.dropdown.data-api", s).on("click.bs.dropdown.data-api",
                ".dropdown form", function (t) {
                t.stopPropagation()
            })
                .on("click.bs.dropdown.data-api", r, o.prototype.toggle).on("keydown.bs.dropdown.data-api", r, o.prototype.keydown).on("keydown.bs.dropdown.data-api",
                    ".dropdown-menu", o.prototype.keydown)
    }
        (jQuery),
    function (a) {
            ...
            s.prototype.backdrop = function (t) {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    if (this.$backdrop = a(document.createElement("div")).addClass("modal-backdrop " + i).appendTo(this.$body),
                        ...
                        !t) return; o ? this.$backdrop.one("bsTransitionEnd", t)
    ...
    function (g) {
        ...
        var o = ["sanitize", "whiteList", "sanitizeFn"],
            ...
            t = {
                ...
                area: [], b: [], br: [], col: [],
                code: [], div: [], em: [], hr: [], h1: [], h2: [], h3: [], h4: [], h5: [], h6: [], i: [],
        ...
        function n(t, e, i) {
            ...
            o.body.innerHTML = t;
            for (var n = g.map(e, function (t, e) { return e }),
                s = g(o.body).find("*"),
                a = 0,
                r = s.length;
                a < r;
        ...
        m.VERSION = "3.4.1",
            ...
            m.prototype.getOptions = function (t) {
                ...
                return (t = g.extend({}, this.getDefaults(), e, t))
                    .delay && "number" == typeof t.delay && (t.delay = { show: t.delay, hide: t.delay }),
            ...
            m.prototype.enter = function (t) {
                ...
                if
                    ...
                    e.tip().hasClass("in") || "in" == e.hoverState) e.hoverState = "in";
                else {
                    if
            ...
            m.prototype.applyPlacement = function (t, e) {
                ...
                isNaN(s) && (s = 0), isNaN(a) && (a = 0),
                    t.top += s, t.left += a, g.offset.setOffset(i[0], g.extend(
                        {
                            using: function (t) {
                                i.css(
                                    {
            ...
            m.prototype.hide = function (t) {
                ...
                function n() {
                    "in" != e.hoverState && i.detach(),
                        e.$element && e.$element.removeAttr("aria-describedby").trigger("hidden.bs." + e.type), t && t()
                }
            ...
            m.prototype.destroy = function () {
                var t = this; clearTimeout(this.timeout),
                    this.hide(function () {
                        t.$element.off("." + t.type).removeData("bs." + t.type),
                            t.$tip && t.$tip.detach(),
                            t.$tip = null, t.$arrow = null,
                            t.$viewport = null, t.$element = null
                    })
            },
    ...
    function (r) {
        ...
        r(document).on("click.bs.tab.data-api",
            '[data-toggle="tab"]', i).on("click.bs.tab.data-api", '[data-toggle="pill"]', i)
    }
        (jQuery),
    function (l) {
        "use strict";
        var h = function (t, e) {
            ...
            this.$target = i.on("scroll.bs.affix.data-api", l.proxy(this.checkPosition, this)).on("click.bs.affix.data-api", l.proxy(this.checkPositionWithEventLoop, this)),
                this.$element = l(t), this.affixed = null, this.unpin = null, this.pinnedOffset = null, this.checkPosition()
        };
        function i(o) {
            return this.each(function () {
                var t = l(this),
